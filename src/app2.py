...
def listar_alumnos():
    try:
        ...
        for fila in datos:
            ...
            listar_alumnos.append(alumno)

        return jsonify({'alumnos': listar_alumnos, 'mensaje': 'Lista de alumnos', 'exito': True})
    except Exception as ex:
        return jsonify({'mensaje': 'Error de conexión', 'exito': False})
